...
export function ProgressionModal({
  ...
  return (
    <div
      ...
      className="bg-foreground/70 fixed inset-0 z-[50000] flex min-h-screen items-center justify-center p-4"
      onClick={() => {
        restoreFocus();
        onClose();
      }}
                ...
                {strengthLoading ? (
                  ...
                  <div className="py-12 text-center">
                    ...
                    <p
                      ...
                      style={{ color: "var(--color-text-muted)" }}
                    >
                      Complete some workouts with {selectedExercise} to see your
                      progression.
                    </p>
                  </div>
                )}
