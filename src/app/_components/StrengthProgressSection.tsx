...
export function StrengthProgressSection() {
  ...
  const maxWeight = strengthData
    ? Math.max(...strengthData.map((d) => d.weight))
    : 0;
  const minWeight = strengthData
    ? Math.min(...strengthData.map((d) => d.weight))
    : 0;
  ...
  return (
    <div className={cardClass + " p-6"}>
      ...
      <div className="mb-6">
        ...
        {exerciseListLoading ? (
          <div className="h-10 animate-pulse rounded-lg bg-[var(--color-bg-surface)]"></div>
        ) : (
          <select
            id="exercise-select"
      ...
      {selectedExercise ? (
        <>
          {strengthLoading ? (
            <div className="space-y-4">
              ...
              <div className="h-32 animate-pulse rounded-lg bg-[var(--color-bg-surface)]"></div>
            </div>
            ...
            <>
              ...
              <div className="mb-6">
                ...
                <div className="relative h-64 rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-surface)] p-4">
                  <svg className="h-full w-full" viewBox="0 0 400 200">
                    ...
                    {chartData.map((point, index) => {
                      const x =
                        (index / Math.max(1, chartData.length - 1)) * 360 + 20;
                      const y =
                        ...
                        <g key={index}>
                          ...
                          {index < chartData.length - 1 && (
                            <line
                              ...
                              y2={
                                180 -
                                ((chartData[index + 1]!.weight - minWeight) /
                                  range) *
                                  160
                              }
            ...
            <div className="py-12 text-center">
              ...
              <p className="text-sm text-[var(--color-text-muted)]">
                Complete some workouts with this exercise to see your strength
                progression.
              </p>
            </div>
          )}
        ...
        <div className="py-12 text-center">
          ...
          <p className="text-sm text-[var(--color-text-muted)]">
            Choose an exercise from the dropdown to view your strength
            progression.
          </p>
        </div>
      )}
