 ...
 *
 * For sign-up, AuthKit automatically shows the sign-up form if the user doesn't have an account.
 */
function RegisterRedirect() {
  ...
  useEffect(() => {
    // Redirect to WorkOS AuthKit (same as login - AuthKit handles both sign-in and sign-up)
