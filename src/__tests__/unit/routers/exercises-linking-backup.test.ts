  ...
  const createQueryChainWithMethods = <TData extends unknown[]>(
    ...
    const chain: any = {
      ...
      returning: vi.fn(async () => {
        // For insert operations, return the first element to match actual implementation
        // The wellness router implementation returns result[0] from the insert operation
