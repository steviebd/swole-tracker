...
function replaceEqualDeep(prev, _next, _depth = 0) {
  ...
  for (let i = 0; i < nextSize; i++) {
    ...
    const v2 = replaceEqualDeep(p2, n, _depth + 1);
    copy[key] = v2;
    if (v2 === p2) equalItems++;
  }
...
function sortDynamic(a, b2) {
  ...
  if (!a.skipOnParamError && b2.skipOnParamError) return 1;
  if (a.skipOnParamError && b2.skipOnParamError && (a.parsingPriority || b2.parsingPriority))
    return b2.parsingPriority - a.parsingPriority;
...
const REACT_USE = "use";
const reactUse = React$1[REACT_USE];
...
if (!globalObj$1[GLOBAL_STORAGE_KEY]) {
  globalObj$1[GLOBAL_STORAGE_KEY] = new AsyncLocalStorage$1();
}
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-dnRozHaY-dnRozHaY.js");
...
const manifest = { "4b856d41b2dc068b7b9e72366ea7c5e7158fb71c2dbeca58360d88554ae61149": {
  functionName: "checkAuth_createServerFn_handler",
  importer: () => import("./auth-Cb6RxCzq-B2L4SdyO.js")
}, "9ec5417241880a99fa9725e00d610469a46dfc9c6a12f03ebe2f021243e6f3b0": {
  functionName: "getUser_createServerFn_handler",
  importer: () => import("./auth-Cb6RxCzq-B2L4SdyO.js")
}, "0d10ec2bf434c6a63c6025f4e70d8057daa98775c0451fea477b00b9354371f4": {
  functionName: "getTemplates_createServerFn_handler",
  importer: () => import("./templates-DPdBcv2H-0OLmu10u.js")
}, "e2e3d77d332e133902a398ee645ee7f1cd2d034180f8d86df13159f9e3a181eb": {
  functionName: "getTemplate_createServerFn_handler",
  importer: () => import("./templates-DPdBcv2H-0OLmu10u.js")
}, "d4d3c0cc524945cea68f72c47f6c715061cde53014bbfeeb760dc13d61761b84": {
  functionName: "createTemplate_createServerFn_handler",
  importer: () => import("./templates-DPdBcv2H-0OLmu10u.js")
}, "75f0b852d5fc0e020075f08dec218ab3c33d26b90fa8924ee1d9ec1cf2715da9": {
  functionName: "updateTemplate_createServerFn_handler",
  importer: () => import("./templates-DPdBcv2H-0OLmu10u.js")
}, "409eddae35c415ebcff85c9c16763eab8439fca2d738be603106039a3431c4f3": {
  functionName: "deleteTemplate_createServerFn_handler",
  importer: () => import("./templates-DPdBcv2H-0OLmu10u.js")
}, "fbea046e6c5c27f1263dce4ac18d00dcd1f56336cbf0f741f248713b27615601": {
  functionName: "duplicateTemplate_createServerFn_handler",
  importer: () => import("./templates-DPdBcv2H-0OLmu10u.js")
}, "fb9289d5f779a5b4fe996fda782a2a89cf001ef5c7784996bd171189ae6ff197": {
  functionName: "getDashboardData_createServerFn_handler",
  importer: () => import("./progress-DthDHKGs-BgHS-e99.js")
}, "1e14bf6fa850eab3da2983181b6c078e78ae6ee93480ffdef1d1ef2db4c8b139": {
  functionName: "getStreak_createServerFn_handler",
  importer: () => import("./progress-DthDHKGs-BgHS-e99.js")
}, "fba5bbdf75b6c8fe864c747a76a1f856f96ca561b924d5e8cc9038fa840b030e": {
  functionName: "getRecentPRs_createServerFn_handler",
  importer: () => import("./progress-DthDHKGs-BgHS-e99.js")
}, "079855d19e1ff5225c05565ca213488718d6f8da115ef1b8e4cc1d49d5489473": {
  functionName: "getHistory_createServerFn_handler",
  importer: () => import("./progress-DthDHKGs-BgHS-e99.js")
}, "83888141dfd73b0a1c0f79aa79bd1600706606070498fabb003413f49cea2a8c": {
  functionName: "getStrengthProgression_createServerFn_handler",
  importer: () => import("./progress-DthDHKGs-BgHS-e99.js")
}, "bda7246fac0ad307a8cf9255a9691c443e17c910bceb81910bfd30657d0675c2": {
  functionName: "getTopSets_createServerFn_handler",
  importer: () => import("./progress-DthDHKGs-BgHS-e99.js")
}, "fd51064e077a7e2c5410450d538d184cd913a23e3a3ec6270cc8d321a0dd35c4": {
  functionName: "getRecentWorkouts_createServerFn_handler",
  importer: () => import("./workouts-C2iTdebV-Cuwwq8aZ.js")
}, "cbd05d3b6e9d4d9a4467af432428ff3ec9668fc1ccf7f11702b49207a36fb60d": {
  functionName: "getWorkout_createServerFn_handler",
  importer: () => import("./workouts-C2iTdebV-Cuwwq8aZ.js")
}, "55efdfc67e8d94993c01213abf20e83bbf2b7c210b536b79494dfd1520cb1817": {
  functionName: "startWorkout_createServerFn_handler",
  importer: () => import("./workouts-C2iTdebV-Cuwwq8aZ.js")
}, "9b45fe33fa458a8d12a12b0f790fd4e5d3cfbf535a2aa0af1ac1128f23fb59b5": {
  functionName: "saveWorkout_createServerFn_handler",
  importer: () => import("./workouts-C2iTdebV-Cuwwq8aZ.js")
}, "2c6c4a36fac579d6a56e784c3cfa8d3d179fe2429aa741eb7a8a21bccbcdd4ea": {
  functionName: "deleteWorkout_createServerFn_handler",
  importer: () => import("./workouts-C2iTdebV-Cuwwq8aZ.js")
}, "084dd54fcd0d58a1a6c106ea10b347a65cbaabb724652b220009787bc3a133c7": {
  functionName: "getLastExerciseData_createServerFn_handler",
  importer: () => import("./workouts-C2iTdebV-Cuwwq8aZ.js")
}, "144b739c4e6847ddfc29a2db156e0bc77a03e853a5310115fbf3017116247b16": {
  functionName: "addExercise_createServerFn_handler",
  importer: () => import("./workouts-C2iTdebV-Cuwwq8aZ.js")
}, "ed37380a60c0937a5841118f118b5fabc26138055aece9b67e48c24c2f20561b": {
  functionName: "updateExercise_createServerFn_handler",
  importer: () => import("./workouts-C2iTdebV-Cuwwq8aZ.js")
}, "3753f848ef10f4aa549312d5ecc266828b151f16d860119bd66f4761a066b144": {
  functionName: "removeExercise_createServerFn_handler",
  importer: () => import("./workouts-C2iTdebV-Cuwwq8aZ.js")
}, "33ab049565bbfc9bddffc879283f4a68cb4e0f70096af31e32228bc27e0871fb": {
  functionName: "addSet_createServerFn_handler",
  importer: () => import("./workouts-C2iTdebV-Cuwwq8aZ.js")
}, "bfda402f223b530d3e6c1e56832336ec22946c59e9cea18601f5ce7b8cff9392": {
  functionName: "updateSet_createServerFn_handler",
  importer: () => import("./workouts-C2iTdebV-Cuwwq8aZ.js")
}, "43e80a2d24c6616ce4a99caf445291d76a3d9757e37805f100474be2cff77a7f": {
  functionName: "deleteSet_createServerFn_handler",
  importer: () => import("./workouts-C2iTdebV-Cuwwq8aZ.js")
} };
...
async function loadEntries() {
  const routerEntry = await import("./router-CfQjAsX4-BdfYCT0U.js").then((n) => n.E).then((n) => n.r);
  const startEntry = await import("./start-HYkvq4Ni-HYkvq4Ni.js");
...
export {
  ...
  getRequest as g,
  useForwardedRef as h,
  invariant as i,
  joinPaths as j,
  isDangerousProtocol as k,
  useIntersectionObserver as l,
  matchContext as m,
  functionalUpdate as n,
  exactPathTest as o,
  removeTrailingSlash as p,
  deepEqual as q,
  rootRouteId as r,
