import { b as reactExports, s as jsxRuntimeExports, c as createServerFn } from "./worker-entry-_S0z7k3x.js";
import { i as isBrowser, h as hasReducedMotionListener, a as initPrefersReducedMotion, p as prefersReducedMotion, c as clsx, b as cn, d as createSsrRpc } from "./router-CfQjAsX4-BdfYCT0U.js";
...
import { o as object, _ as _enum, n as number$1, s as string } from "./schemas-Dk_VZEFo.js";
  ...
  ({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      Comp,
      {
        ...
        "aria-pressed": interactive ? false : void 0,
...
const buttonPressVariants = {
  ...
  hover: {
    ...
    y: -2,
    transition: {
      duration: AnimationDurations.fast / 1e3,
...
const Skeleton = reactExports.forwardRef(
  ({
    className,
    variant,
    size,
    ...
    const accessibilityProps = announce ? { role: "status", "aria-label": ariaLabel } : { "aria-hidden": true };
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        ...props,
        children: [
          shimmer && !prefersReducedMotion2 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              className: "pointer-events-none absolute inset-0",
              style: {
                backgroundSize: "200% 100%",
                backgroundImage: "linear-gradient(90deg, transparent, color-mix(in srgb, currentColor 24%, transparent 76%), transparent)"
              },
          ...
          shimmer && prefersReducedMotion2 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                backgroundColor: "color-mix(in srgb, currentColor 18%, transparent 82%)"
              }
            }
          )
        ]
...
})).middleware([withAuth]).handler(createSsrRpc("fb9289d5f779a5b4fe996fda782a2a89cf001ef5c7784996bd171189ae6ff197"));
const getStreak = createServerFn({
  method: "GET"
}).middleware([withAuth]).handler(createSsrRpc("1e14bf6fa850eab3da2983181b6c078e78ae6ee93480ffdef1d1ef2db4c8b139"));
createServerFn({
  method: "GET"
}).inputValidator(object({
  limit: number$1().int().positive().default(10)
})).middleware([withAuth]).handler(createSsrRpc("fba5bbdf75b6c8fe864c747a76a1f856f96ca561b924d5e8cc9038fa840b030e"));
createServerFn({
  method: "GET"
}).inputValidator(object({
  limit: number$1().int().positive().default(50),
  offset: number$1().int().nonnegative().default(0)
})).middleware([withAuth]).handler(createSsrRpc("079855d19e1ff5225c05565ca213488718d6f8da115ef1b8e4cc1d49d5489473"));
createServerFn({
  method: "GET"
}).inputValidator(object({
  exerciseName: string().min(1).optional(),
  timeRange: _enum(["week", "month", "quarter", "year"]).default("month"),
  limit: number$1().int().positive().default(100)
})).middleware([withAuth]).handler(createSsrRpc("83888141dfd73b0a1c0f79aa79bd1600706606070498fabb003413f49cea2a8c"));
createServerFn({
  method: "GET"
}).inputValidator(object({
  exerciseName: string().optional(),
  limit: number$1().int().positive().default(10)
})).middleware([withAuth]).handler(createSsrRpc("bda7246fac0ad307a8cf9255a9691c443e17c910bceb81910bfd30657d0675c2"));
const dashboardDataQueryOptions = (timeRange) => queryOptions({
...
const streakQueryOptions = queryOptions({
  queryKey: ["streak"],
  queryFn: () => getStreak(),
  staleTime: 1e3 * 60 * 30
});
...
function formatVolume(volume) {
  if (volume >= 1e6) {
    return `${(volume / 1e6).toFixed(1)}M kg`;
  } else if (volume >= 1e3) {
    return `${(volume / 1e3).toFixed(1)}K kg`;
  }
...
function LoadingSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4", children: Array.from({ length: 4 }).map((_, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    Card,
    {
      className: "relative overflow-hidden border-0 shadow-lg",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "relative space-y-4 p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-12 w-12 rounded-xl" }) }),
...
function StatsCards() {
  const { data: dashboardData, isLoading: isDashboardLoading } = useDashboardData("week");
  ...
  const goalStatus = goalProgress >= 100 ? workoutCount > WEEKLY_GOAL_TARGET ? "Exceeded goal!" : "Goal achieved!" : goalProgress >= 67 ? "Great progress!" : goalProgress >= 33 ? "Good start" : "Keep going";
  const stats = [
    {
      title: "This Week",
    ...
    },
    {
      ...
      change: currentStreak >= longestStreak && currentStreak > 0 ? "Personal best!" : `Best: ${longestStreak} days`,
      icon: Flame,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4", children: stats.map((stat, index) => {
      ...
      Card,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "relative p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 flex items-center justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `rounded-xl bg-gradient-to-br p-3 ${stat.gradient}`,
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "text-primary-foreground h-6 w-6" })
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm font-medium", children: stat.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-serif text-3xl font-black", children: stat.value }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: stat.change })
            ] })
          ] })
        ]
      },
...
const QuickActions = reactExports.lazy(() => import("./quick-actions-CCKhgoZ_-C-8RRvet.js").then((m) => ({
  default: m.QuickActions
})));
const WeeklyProgress = reactExports.lazy(() => import("./weekly-progress-VP2bBWfk-BjzrpI8_.js").then((m) => ({
  default: m.WeeklyProgress
})));
const RecentWorkouts = reactExports.lazy(() => import("./recent-workouts-TytV3Q-i-k5IoDl_r.js").then((m) => ({
  default: m.RecentWorkouts
})));
function Dashboard() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-app-gradient min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 pt-10 pb-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "flex flex-col gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-muted/50 h-16 animate-pulse rounded-lg" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(QuickActions, {}) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid gap-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-muted/50 h-64 animate-pulse rounded-lg" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(WeeklyProgress, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-muted/50 h-64 animate-pulse rounded-lg" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(RecentWorkouts, {}) })
    ] })
  ] }) });
}
const _app__index = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  component: Dashboard
}, Symbol.toStringTag, { value: "Module" }));
const _app__indexCJwPGQVf = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  C: Card,
  S: Skeleton,
  _: _app__index,
...
export {
  ...
  isHTMLElement as i,
  useReducedMotion as j,
  buttonPressVariants as k,
  motion as m,
  triggerHapticFeedback as t,
