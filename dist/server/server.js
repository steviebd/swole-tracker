...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-oKv1ea1c.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-CXtXYmw3.js");
...
const IS_PRERENDERING = define_process_env_default.TSS_PRERENDERING === "true";
const IS_SHELL_ENV = define_process_env_default.TSS_SHELL === "true";
const IS_DEV = define_process_env_default.NODE_ENV === "development";
